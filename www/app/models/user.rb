class User < ActiveRecord::Base
  ...
  def balance_unrealized
    cache_fetch_key_else "unrealized" do load_balance; return Rails.cache.fetch cache_key("unrealized") end
  end
  
  def balance_realized
    cache_fetch_key_else "realized" do load_balance; return Rails.cache.fetch cache_key("realized") end
  end
